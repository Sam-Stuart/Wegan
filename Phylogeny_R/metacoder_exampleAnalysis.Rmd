...
# I want to write a function to calculate relative abundance (proportion) at different 
# taxonomic ranks 
...
names(taxa_data_df1) %in% "c_"

taxa_data_df1_long <- taxa_data_df1 %>% 
    gather(key = "tax_rank", value = "tax_name", -c(1:54))  
...
# As taxonomy levels are mixed, I aggregate lower taxonomic levels to 
# a highest one, phylum 
...
# Stack bar plot at phylum level 
ggplot(phylum_sumCount, 
       aes(x = sample_id,
           y = count_perTaxon, 
           fill = tax_name)) +
