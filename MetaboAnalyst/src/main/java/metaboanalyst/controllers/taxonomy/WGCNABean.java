...
//    } 
    ...
    //STATIC DROPDOWN
    private int taxPowerOpts = 6; //FUNCTION CORRESPONDS WITH applicationBean1.vegdistMeasureOpts
    
    public int setTaxPowerOpts() {
        return taxPowerOpts;
    }

    public void gettaxPowerOpts(int taxPowerOpts) {
        this.taxPowerOpts = taxPowerOpts;
    }
...
//    OAUtils.PlotPCOA2DOrdination(sb, ellipseOpts, var_arrowsOpts, env_arrowsOpts, env_centOpts, sampleNamesOpts, ordColorOpts, pcoaMetaColumnName, sb.getNewImage("ord_pcoa_2D"), "png", 72);
    ...
    public void pcoa_2D_Update_action() {
        ...
        TaxonomyUtils.PlotWGCNAGeneNetwork(sb, doCustomNorm);
        }
