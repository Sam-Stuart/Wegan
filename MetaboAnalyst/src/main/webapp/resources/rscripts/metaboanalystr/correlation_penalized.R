...
#'Plot predicted vs actual test data with x=y line displayed
#'@description Scatter plot with x=y line, where predicted values are x and actual values are y
