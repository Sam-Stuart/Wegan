    ...
    function DragNodes(s, renderer, a) {
        ...
        function nodeMouseMove(event) {
            ...
            function executeNodeMouseMove() {
                ...
                if (divx === 0)
                    divx = 1; //fix edge case where axis are aligned

                var divy = (b.renY - a.renY);
                if (divy === 0)
                    divy = 1; //fix edge case where axis are aligned
